...
public static class ThemeCatalog
{
    ...
    [
        ...
        new(
            ...
            "Kanagawa",
            "Warm sumi-ink surfaces with parchment text and a calm wave-aqua accent, like an aged scroll.",
            IsDark: true,
            PreviewBackground: "#221F1A",
            PreviewSurface: "#2D2922",
            PreviewAccent: "#7AA89F",
            PreviewText: "#DCD7BA"),
        new(
            ThemePreference.Crimson,
            "Crimson",
            "Deep wine and burgundy surfaces lit by a vivid crimson accent. Dramatic and bold.",
            IsDark: true,
            PreviewBackground: "#1C0F12",
            PreviewSurface: "#2B161A",
            PreviewAccent: "#EE3B54",
            PreviewText: "#F6E2E4"),
        new(
            ThemePreference.Graphite,
            "Graphite",
            "Pure neutral grayscale with a silver accent. Minimalist, no colour but the essentials.",
            IsDark: true,
            PreviewBackground: "#161616",
            PreviewSurface: "#242424",
            PreviewAccent: "#D6D6D6",
            PreviewText: "#ECECEC"),
        new(
            ThemePreference.Mint,
            "Mint",
            "Fresh pale-mint daytime palette with a clean green accent. Crisp and light.",
            IsDark: false,
            PreviewBackground: "#E7F6EE",
            PreviewSurface: "#F6FCF9",
            PreviewAccent: "#12A06A",
            PreviewText: "#12352A"),
        new(
            ThemePreference.Lavender,
            "Lavender",
            "Soft lilac daytime palette with a gentle violet accent. Airy and calm.",
            IsDark: false,
            PreviewBackground: "#F3EFFB",
