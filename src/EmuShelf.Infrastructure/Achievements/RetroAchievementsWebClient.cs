...
public sealed class RetroAchievementsWebClient : IRetroAchievementsClient
{
    ...
    private static RetroAchievementsRequestStatus MapStatusCode(HttpStatusCode code) => code switch
    {
        ...
        >= HttpStatusCode.InternalServerError => RetroAchievementsRequestStatus.ServerError,
    ...
    private static RetroAchievementsProfile? ParseProfile(string body)
    {
    ...
    private static IReadOnlyList<RetroAchievementsCatalogueGame>? ParseGameList(string body)
    {
        using var document = JsonDocument.Parse(body);
    ...
    private static IReadOnlyList<RetroAchievementsGameProgress>? ParseUserProgress(string body)
    {
        using var document = JsonDocument.Parse(body);
